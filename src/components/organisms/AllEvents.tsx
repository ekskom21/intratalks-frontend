...
const AllEvents: React.FC = () => {
    ...
    return (
        <>
            ...
            {isSignedIn ? (
                <p>
                    Her kan du se alle arrangementene i årets utgave av TechTalks. For å legge inn ønsker for hvilke
                    arrangementer du vil delta på kan du enten: 1) gå inn på et arrangement og trykke på &quot;Jeg vil
                    delta på dette arrangementet&quot;, eller 2){' '}
                ...
                <p>
                    For å velge ønskede arrangementer til TechTalks må du først logge inn via navigasjons-baren på
                    toppen av skjermen.
                </p>
            )}
